 ...
 */
namespace Codilar\Catalog\Block\Product;
use Magento\Catalog\Api\ProductRepositoryInterface;
use Magento\Catalog\Model\Category;
use Magento\Catalog\Block\Product\AbstractProduct;
use Magento\Catalog\Helper\Data;

//use Codilar\Catalog\Helper\GroupedProductPrice;
...
class View extends AbstractProduct implements \Magento\Framework\DataObject\IdentityInterface
{
    ...
    public function __construct(
        ...
        \Magento\Framework\Pricing\Helper\Data $newPriceCurrency,
        \Codilar\Catalog\Helper\GroupedProductPrice $groupedProductPrice,
        Data $taxPrice,
        array $data = []
    ) {
        ...
        $this->priceHelper = $priceCurrency;
        $this->groupedProductPrice = $groupedProductPrice;
        $this->taxHelper = $taxPrice;
    ...
    {
        return $this->priceHelper->convertAndFormat($this->getProduct()->getFinalPrice());
    }
    ...
    public function getGroupedProductPrice()
    {
        $product = $this->getProduct();
        $totalPrice = $this->groupedProductPrice->getGroupedFinalPrice($product);
        return ( $this->getProductTypes()==='grouped')?
        $this->priceHelper->convertAndFormat($totalPrice) :
        $this->priceHelper->convertAndFormat($this->taxHelper->getTaxPrice($product,$product->getFinalPrice(),true));
    }
